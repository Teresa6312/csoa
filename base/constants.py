...
TASK_TYPE_CHOICES = (
    ...
    (TASK_TYPE_AUTO, 'Auto (task to created task instance by system workflow to auto detact the next task)'), 
...
ROLE_TEAM_GROUP_TYPE = [NORMAL_TEAM_ROLE_TYPE,TEAM_MANAGER_ROLE_TYPE,APP_TEAM_ROLE_TYPE] 
ROLE_DEPARTMENT_GROUP_TYPE =  [NORMAL_DEPARTMENT_ROLE_TYPE,DEPARTMENT_MANAGER_ROLE_TYPE,APP_DEPARTMENT_ROLE_TYPE,DEPARTMENT_SENIOR_ROLE_TYPE]
ROLE_COMPANY_GROUP_TYPE = [NORMAL_COMPANY_ROLE_TYPE,COMPANY_MANAGER_ROLE_TYPE,APP_COMPANY_ROLE_TYPE]
ROLE_BELONGS_GROUP_TYPE = [NORMAL_TEAM_ROLE_TYPE,NORMAL_DEPARTMENT_ROLE_TYPE,NORMAL_COMPANY_ROLE_TYPE,TEAM_MANAGER_ROLE_TYPE,DEPARTMENT_MANAGER_ROLE_TYPE] 
ROLE_PERMS_GROUP_TYPE = [APP_TEAM_ROLE_TYPE,APP_DEPARTMENT_ROLE_TYPE, APP_COMPANY_ROLE_TYPE] 
ROLE_TEAM_BELONGS_GROUP_TYPE = [NORMAL_TEAM_ROLE_TYPE,TEAM_MANAGER_ROLE_TYPE]
ROLE_DEPARTMENT_BELONGS_GROUP_TYPE = [NORMAL_DEPARTMENT_ROLE_TYPE,DEPARTMENT_MANAGER_ROLE_TYPE]
