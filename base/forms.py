...
class MultipleFileInput(forms.ClearableFileInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        if attrs is None:
            attrs = {}
        attrs['data-max-files'] = settings.FILE_UPLOAD_MAX_VOLUME  # Add the data attribute
    ...
    def get_context(self, name, value, attrs):
        ...
        if isinstance(value, InMemoryUploadedFile):
            ...
            context['widget']['display_value'] = value.name  # Set the display value to the file name
        else:
