...
urlpatterns=[
    ...
    path('app/<str:app_name>/my-cases/<str:type>',  views_case.get_my_cases_view_data, name='app_my_cases_data'),

    path('app/<str:app_name>/cases/search/<str:form_code>/<int:app_id>-<int:form_id>-<int:index>-filter', views_case.get_cases_search_by_form_view_data, name='app_cases_search_form_Data'), # for searching large data set, match with base:app_cases_search_form
    path('app/<str:app_name>/cases/<str:form_code>/details/history/<int:case_id>-filter', request_decorator(views_case.get_case_details_history_json), name='app_case_details_history'), # app:app_case_details
    path('app/<str:app_name>/cases/<str:form_code>/details/documents/<int:case_id>-filter', request_decorator(views_case.get_case_details_documents_json), name='app_case_details_documents'), # app:app_case_details
    ...
    path('app/<str:app_name>/cases/<str:form_code>/file-download/<int:case_id>-filter/<str:file_id>-filter', views_case.get_case_details_file_download_view, name='app_case_details_file_download'), # app:app_case_details
