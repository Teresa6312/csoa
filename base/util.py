...
from django.utils.functional import (
    Promise,
)  # Import the Promise class for from django.utils.translation import gettext_lazy as _ values
import re
import logging
...
class CustomJSONEncoder(json.JSONEncoder):
    ...
    def default(self, obj):
        ...
        if isinstance(
            obj, bool
        ):  # Check for standard booleans This one doesn't work for some reason
