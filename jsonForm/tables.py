...
def create_dynamic_case_data_table_class(column_headers, default_fields=None, show_detail=False):
    """
    ...
    if show_detail:
        attrs['details'] = tables.LinkColumn('app:app_case_details', text='Details',  verbose_name='Details', args=[A('case__form__application__key'), A('case__id')], orderable=False, empty_values=())
